...
class Keyboards(metaclass=Singleton):
    ...
    def settings_menu(self):
        ...
        itm_btn_1 = InlineKeyboardButton('Время', callback_data='TIME')
        itm_btn_2 = InlineKeyboardButton('"БЕС"предел', callback_data='LIMIT')
        itm_btn_3 = InlineKeyboardButton('ХАРЭ', callback_data='START')
        self.markup.row(itm_btn_1, itm_btn_2, itm_btn_3)
        return self.markup
    ...
    def min_choice(self):
        ...
        self.markup = InlineKeyboardMarkup()
        itm_btn_1 = InlineKeyboardButton('1', callback_data='60')
        itm_btn_2 = InlineKeyboardButton('3', callback_data='180')
        itm_btn_3 = InlineKeyboardButton('5', callback_data='300')
        self.markup.row(itm_btn_1, itm_btn_2, itm_btn_3)
        return self.markup
